...
import com.research.service.dto.DepartmentDTO;
import com.research.service.mapper.DepartmentMapper;
...
public class DepartmentResourceIntTest {
    ...
    private static final String DEFAULT_DEPT_TYPE = "AAAAAAAAAA";
    private static final String UPDATED_DEPT_TYPE = "BBBBBBBBBB";
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getDeptType()).isEqualTo(DEFAULT_DEPT_TYPE);
        assertThat(testDepartment.getContactPerson()).isEqualTo(DEFAULT_CONTACT_PERSON);
        assertThat(testDepartment.getContactInfo()).isEqualTo(DEFAULT_CONTACT_INFO);
    }
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].deptType").value(hasItem(DEFAULT_DEPT_TYPE.toString())))
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.deptType").value(DEFAULT_DEPT_TYPE.toString()))
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.getDeptType()).isEqualTo(UPDATED_DEPT_TYPE);
        assertThat(testDepartment.getContactPerson()).isEqualTo(UPDATED_CONTACT_PERSON);
        assertThat(testDepartment.getContactInfo()).isEqualTo(UPDATED_CONTACT_INFO);
    }
