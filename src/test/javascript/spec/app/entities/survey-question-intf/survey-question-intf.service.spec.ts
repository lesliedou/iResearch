...
describe('Service Tests', () => {
    ...
    describe('SurveyQuestionIntf Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SurveyQuestionIntfService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/survey-question-intfs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SurveyQuestionIntf', () => {
