...
import { SurveyDialogComponent } from '../../../../../../main/webapp/app/entities/survey/survey-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Survey Management Dialog Component', () => {
        let comp: SurveyDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(SurveyDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'surveyListModification', content: 'OK'});
