...
class TargetGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Target entity")
        ...
        .repeat(2) {
            ...
            .post("/api/targets")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "targetName":"SAMPLE_TEXT", "targetType":"SAMPLE_TEXT", "targetTypeReadme":"SAMPLE_TEXT", "contactPerson":"SAMPLE_TEXT", "contactPhone":"SAMPLE_TEXT", "contactEmail":"SAMPLE_TEXT", "contactAddr":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
