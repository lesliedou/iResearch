...
currentAccount: any;
    ...
    loadAll() {
        this.monthlyReportService.query({
            page: this.page - 1,
            size: this.itemsPerPage,
            sort: this.sort()}).subscribe(
                (res: HttpResponse<MonthlyReport[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/monthly-report'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: MonthlyReport) {
        return item.id;
    }
